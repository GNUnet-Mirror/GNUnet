...
/**
 * TODO:
 * If you remove an entry from finger table, and if the finger is not your friend 
 ...
 * table. 
 * 2. how to handle the case in which same finger identity is stored for different
